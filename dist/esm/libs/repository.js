...
export class Repository {
    constructor(is_wipe = false) {
        this.fs = new LightningFS('fs', { wipe: is_wipe });
    ...
    async push() {
        ...
        await git.statusMatrix(repo).then((status) => Promise.all(status.map(([filepath, , worktreeStatus]) => worktreeStatus ? git.add(Object.assign(Object.assign({}, repo), { filepath })) : git.remove(Object.assign(Object.assign({}, repo), { filepath })))));
        await git.commit(Object.assign(Object.assign({}, repo), { author: {
                name: 'Nobe Client',
                email: 'nobeclient@gmail.com',
